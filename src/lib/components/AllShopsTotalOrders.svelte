<script>
    ...
    let data = [
        {
            title: "Total Order of ISW-Netherlands",
            totalOrder: {
                show:"w-[60%] bg-sky-500" , value: 120
            },
            pendingOrder:{
                show:"w-[30%] bg-orange-500" , value: 20
            },
            completeOrder:{
                show:"w-[30%] bg-green-500" , value: 100
            }
        },
        {
            title: "Total Order of ISW-Belgium",
            totalOrder: {
                show:"w-[60%] bg-sky-500" , value: 120
            },
            pendingOrder:{
        ...
        {
            title: "Total Order of ISW-Germany",
            totalOrder: {
                show:"w-[60%] bg-sky-500" , value: 120
            },
            pendingOrder:{
